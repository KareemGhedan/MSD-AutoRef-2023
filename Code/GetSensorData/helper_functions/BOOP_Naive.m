function  ball_in = BOOP_Naive(ball_pos, field_size, ball_radius)
    ...
    switch nargin
        case 1
            field_size = [-4.08 4.08;-6.12 6.12];
            ball_radius = 11e-2;
        case 2
            ball_radius = 11e-2;
    end
    ...
    cond1 = (ball_pos(1)-ball_radius) > field_size(2,2);
    cond2 = (ball_pos(2)-ball_radius) > field_size(1,2);
    cond3 = (ball_pos(2)-ball_radius) > field_size(1,1);
    cond4 = (ball_pos(1)-ball_radius) > field_size(2,1);
