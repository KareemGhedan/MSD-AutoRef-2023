...
% 07/03/2024
% Livestream Version
function  [ball_in, margin] = BOOP(x_current,z_current, x_prev, z_prev, dummy_count)
...
if intermediate_points(j,1)-ball_radius > field_z(1,2) || intermediate_points(j,2)-ball_radius > field_x(1,1)|| ...
